		<!-- Header -->
			<header id="header" style="background-color: black;">
				<h1><a href="<?php echo base_url();?>index.php/Principal/inicio">Director</a></h1>
				...
				<nav id="nav">
					<ul>
						...
						<li><a href="<?php echo base_url();?>index.php/doc/ver">V. Doctor</a></li>
						<li><a href="<?php echo base_url();?>index.php/Doctor/ver_horario">C. horario</a></li>
						...
						<li><a href="<?php echo base_url();?>index.php/Paciente/verNuevo">C. paciente.</a></li>
